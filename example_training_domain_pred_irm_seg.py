...
configs = [
    # {'experiment_name': 'dompred3_harp_dryad_hybrid_aug_vrex2', 'device': 'cuda:0',
    ...
    #  },
    # {'experiment_name': 'dompred3_decath_dryad_hybrid_aug_vrex2', 'device': 'cuda:0',
    #  'nr_runs': 5, 'cross_validation': True, 'val_ratio': 0.1, 'test_ratio': 0.3,
    #  'input_shape': (1, 48, 64, 64), 'resize': False, 'augmentation': 'hybrid',
    #  'class_weights': (0., 1.), 'lr': 2e-4, 'batch_sizes': [13, 3],
    #  "beta": 10,
    ...
    #  },
    {'experiment_name': 'dompred3_decath_harp_hybrid_aug_vrex2', 'device': 'cuda:0',
     'nr_runs': 5, 'cross_validation': True, 'val_ratio': 0.1, 'test_ratio': 0.3,
     'input_shape': (1, 48, 64, 64), 'resize': False, 'augmentation': 'hybrid',
     'class_weights': (0., 1.), 'lr': 2e-4, 'batch_sizes': [6, 6],
     "beta": 10,
     "loss": "vrex", "eval_interval": 10,
